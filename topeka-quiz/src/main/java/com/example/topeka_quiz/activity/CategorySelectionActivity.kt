...
package com.example.topeka_quiz.activity
...
import com.example.topeka_quiz.fragment.CategorySelectionFragment
...
class CategorySelectionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = setContentView<ActivityCategorySelectionBinding>(this,
